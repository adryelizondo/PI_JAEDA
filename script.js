...
function calculateIMC() {
  ...
  if (imc < 18.5) {
    ...
    document.getElementById("image").src = "insuficiente.jpg";
    desc.style.backgroundColor = "#19c9e0";
    desc.innerHTML = imc + " " + mensaje;
  } else if (imc >= 18.5 && imc < 25) {
    mensaje = "Peso Normal";
    document.getElementById("image").src = "normal.jpg";
    desc.style.backgroundColor = "#20c926";
    desc.innerHTML = imc + " " + mensaje;
  } else if (imc >= 25 && imc < 30) {
    mensaje = "Sobrepeso";
    document.getElementById("image").src = "sobrepeso.jpg";
    desc.style.backgroundColor = "#face0a";
    desc.innerHTML = imc + " " + mensaje;
  } else if (imc >= 30 && imc < 40 ) {
    mensaje = "Obeso";
    document.getElementById("image").src = "obeso.jpg";
    desc.style.backgroundColor = "#f51448";
    desc.innerHTML = imc + " " + mensaje;
  } else if (imc >= 40) {
    mensaje = "Obesidad de Alto Riesgo";
    document.getElementById("image").src = "obesidad.jpg";
